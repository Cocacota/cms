...
if (!function_exists('newscrunch_theme_layout')) :
	...
	function newscrunch_theme_layout() {
	    ...
	    if ($newscrunch_theme_layout == "boxed") {
	        $newscrunch_layout_type = "boxed ".$newscrunch_highlight_view .$newscrunch_pstlayout_class;
	    } 
	    else {
	        $newscrunch_layout_type = "wide ".$newscrunch_highlight_view .$newscrunch_pstlayout_class;
	    }?>
